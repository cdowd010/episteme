...
# → GatewayResult(status="ok", changed=True, transaction_id="def-456")

gateway.transition("prediction", "P-001", "CONFIRMED")
# → GatewayResult(status="ok", changed=True, transaction_id="ghi-789")
...
classDef bigText font-size:18px,color:#111111;
    ...
    style PAR001 fill:#FF0000,stroke:#FFA500
    style A001 fill:#FFB74D,stroke:#E65100
    style AN001 fill:#64B5F6,stroke:#1565C0
    style C001 fill:#66BB6A,stroke:#2E7D32
    style P001 fill:#CE93D8,stroke:#8E24AA
    style IG001 fill:#B0BEC5,stroke:#546E7A
```
...
classDef bigText font-size:18px,color:#111111;
    ...
    style A001 fill:#FFB74D
    style PAR001 fill:#FF0000
    style AN001 fill:#64B5F6
    style C001 fill:#66BB6A
    style P001 fill:#CE93D8
    style OBS fill:#FFCDD2,stroke:#C62828
    style OUT fill:#A5D6A7,stroke:#2E7D32,stroke-width:2px
```
...
classDef bigText font-size:18px,color:#111111;
    ...
    style C001 fill:#66BB6A,stroke:#2E7D32
    style C002 fill:#66BB6A,stroke:#2E7D32
    style C003 fill:#A5D6A7,stroke:#388E3C,stroke-width:2px
    style LIN fill:#E0E0E0,stroke:#757575
    style DEP fill:#E0E0E0,stroke:#757575
```
...
classDef bigText font-size:18px,color:#111111;
    ...
    style A001 fill:#FFB74D,stroke:#E65100,stroke-width:2px
    style P001 fill:#CE93D8,stroke:#2E7D32,stroke-width:2px
    style P002 fill:#CE93D8,stroke:#8E24AA
```
...
|---|---|
| <span style="display:inline-block;width:0.95em;height:0.95em;border-radius:3px;background:#FFB74D;border:1px solid #E65100;"></span> | Assumption |
| <span style="display:inline-block;width:0.95em;height:0.95em;border-radius:3px;background:#CE93D8;border:2px solid #2E7D32;"></span> | Prediction: tests assumption |
| <span style="display:inline-block;width:0.95em;height:0.95em;border-radius:3px;background:#CE93D8;border:1px solid #8E24AA;"></span> | Prediction: conditional on assumption |
...
classDef bigText font-size:18px,color:#111111;
    ...
    style AN001 fill:#64B5F6
    style C001 fill:#66BB6A
    style C002 fill:#66BB6A
    style IG001 fill:#B0BEC5
    style P001 fill:#CE93D8
    style P002 fill:#CE93D8
```
...
classDef bigText font-size:18px,color:#111111;
    ...
    style PAR001 fill:#F44336,stroke:#C62828,stroke-width:2px
    style AN001 fill:#FFCDD2,stroke:#E57373
    style C001 fill:#FFCC80,stroke:#EF6C00
    style C002 fill:#FFCC80,stroke:#EF6C00
    style P001 fill:#E1BEE7,stroke:#8E24AA
    style P002 fill:#E1BEE7,stroke:#8E24AA
    style ACTION fill:#FFF176,stroke:#F9A825
```
...
classDef bigText font-size:18px,color:#111111;
    ...
    style C001 fill:#C62828,stroke:#C62828,stroke-width:2px
    style C002 fill:#66BB6A
    style C003 fill:#66BB6A
    style P001 fill:#CE93D8
...
classDef bigText font-size:18px,color:#111111;
    ...
    style LS fill:#E0E0E0,stroke:#757575
```
...
classDef bigText font-size:18px,color:#111111;
    ...
    style PAR001 fill:#FF0000
    style A001 fill:#FFB74D,stroke:#E65100,stroke-width:2px
    style A002 fill:#FFB74D
    style T001 fill:#9FA8DA,stroke:#5C6BC0
    style C001 fill:#66BB6A
    style C002 fill:#66BB6A
    style C003 fill:#A5D6A7,stroke:#388E3C,stroke-width:2px
    style AN001 fill:#64B5F6
...
classDef bigText font-size:18px,color:#111111;
    ...
    style GR fill:#9FA8DA
    style C1 fill:#66BB6A
    style C2 fill:#66BB6A
    style C3 fill:#A5D6A7,stroke:#388E3C,stroke-width:2px
    style A001 fill:#FFB74D,stroke:#2E7D32,stroke-width:2px
    style A002 fill:#FFB74D
    style P001 fill:#CE93D8,stroke:#8E24AA,stroke-width:2px
    style OBS fill:#FFCDD2,stroke:#C62828
    style OUT fill:#A5D6A7,stroke:#2E7D32,stroke-width:2px
```
...
classDef bigText font-size:18px,color:#111111;
    ...
    style PAR001 fill:#FF0000
    style PAR002 fill:#FF0000
    style A001 fill:#FFB74D,stroke:#D84315,stroke-width:2px
    style A002 fill:#FFB74D
    style C001 fill:#66BB6A
    style C002 fill:#66BB6A
    style AN001 fill:#64B5F6
...
# → ok | P-001 → REFUTED
# Validator: tier constraints are satisfied (MEASURED + observed is present).
# P-001.analysis = "AN-001" preserves provenance for the refutation record.
```
...
classDef bigText font-size:18px,color:#111111;
    ...
    style C001 fill:#FFCC80,stroke:#EF6C00
    style C002 fill:#FFCC80,stroke:#EF6C00
    style A001 fill:#FF8A65,stroke:#D84315,stroke-width:2px
    style A002 fill:#FF8A65,stroke:#D84315
    style DE001 fill:#FFCDD2,stroke:#C62828
    style NOTE fill:#E0E0E0,stroke:#757575,stroke-dasharray:4
```
...
classDef bigText font-size:18px,color:#111111;
    ...
    style P001 fill:#CE93D8,stroke:#8E24AA
    style OBS fill:#FFCDD2,stroke:#C62828
    style REFUTED fill:#FFCDD2,stroke:#C62828,stroke-width:2px
    style AFTERMATH fill:#C5CAE9,stroke:#546E7A,stroke-width:2px
```
...
| <span style="display:inline-block;width:0.95em;height:0.95em;border-radius:3px;background:#C5CAE9;border:1px solid #5C6BC0;"></span> | Aftermath / paradigm shift |
...
classDef bigText font-size:18px,color:#111111;
    ...
    style A002 fill:#FFB74D
    style C001 fill:#66BB6A
    style C002 fill:#A5D6A7,stroke:#388E3C
    style AN001 fill:#64B5F6
    style IG001 fill:#B0BEC5
    style P001 fill:#CE93D8,stroke:#8E24AA
```
...
**Two months later — regulatory governance change 1 updates the existing precision threshold parameter from 0.85 to 0.90.**

```python
# Update the existing PAR-002 record.
...
classDef bigText font-size:18px,color:#111111;
    ...
    style PAR1 fill:#F44336,stroke:#C62828
    style PAR2 fill:#FF0000,stroke:#FFA500
    style AN1a fill:#FFCDD2
    style AN1b fill:#FFCDD2
    style C2a fill:#FFCC80
    style C2b fill:#FFCC80
    style P1a fill:#CE93D8
    style P1b fill:#CE93D8
    style OK fill:#A5D6A7,stroke:#2E7D32
    style STRESS fill:#FFE082,stroke:#EF6C00,stroke-width:2px
```
...
```python
from desitter.views.health import run_health_check
...
classDef bigText font-size:18px,color:#111111;
    ...
    style A002 fill:#FFB74D
    style C001 fill:#66BB6A
    style C002 fill:#A5D6A7
    style P001_init fill:#CE93D8
    style PAR1 fill:#F44336,stroke:#C62828
    style RERUN fill:#FFCDD2,stroke:#C62828
    style P001_final fill:#FFE082,stroke:#EF6C00,stroke-width:2px
    style GAP fill:#FFF176,stroke:#F9A825,stroke-width:2px
```
