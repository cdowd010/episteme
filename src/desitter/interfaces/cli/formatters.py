...
def print_status(status: ProjectStatus, *, as_json: bool = False) -> None:
    ...
    table.add_row("Analyses", str(m.analysis_count))
    table.add_row("Theories", str(m.theory_count))
    table.add_row("Discoveries", str(m.discovery_count))
    table.add_row("Dead Ends", str(m.dead_end_count))
    table.add_row("Parameters", str(m.parameter_count))
    table.add_row("Independence Groups", str(m.independence_group_count))
    table.add_row("Pairwise Separations", str(m.pairwise_separation_count))
